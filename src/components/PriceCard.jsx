        ...
        <div className="my-20">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                {plans.map((plan, index) => (
                    <div key={index} className={`shadow-lg rounded-lg p-6 flex flex-col justify-between ${plan.name === 'Pro' ? 'bg-gradient-to-r from-blue-500 to-purple-600 md:mt-[-20px] md:mb-[20px] shadow_special' : 'bg-n-10/30 md:mt-[10px]'} z-2`}>
                        <div>
